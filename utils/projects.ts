...
UI-Verhalten, Datenkonsistenz und langfristige Wartbarkeit verbessert.`,
  ...
  },
  {
    ...
    image: "/integrations/syniotec/syniotec.png",
    showcaseImage: "/integrations/syniotec/syniotec.png",
    summary:
      "Syniotec is rental operations software: teams manage equipment, bookings and contracts, and invoicing for rental work. Billing flows into Haufe X360 for finance, while new customers and equipment created in X360 sync straight into Syniotec RAM so rental work stays aligned.",
    badge: "Integration",
    tech: [
      "Bun",
      "Elysia",
    ...
    highlights: [
      ...
      "Pushes new equipment from Haufe X360 to Syniotec RAM as soon as it is created, so planners work off the same fleet.",
      "Pushes new customers from Haufe X360 to Syniotec RAM as soon as they are created, so bookings and invoices use the right account.",
    ...
    tasks: [
      ...
      "When a new customer is created in Haufe X360, sync it to Syniotec RAM immediately so rental bookings and invoices use the same account.",
      "When new equipment is created in Haufe X360, sync it to Syniotec RAM immediately so planners see the same fleet in the rental system.",
    ...
    timeline: [
      ...
      },
      {
        ...
        detail:
          "Create customers and equipment in Haufe X360 and have them appear in Syniotec RAM right away, so IDs and accounts line up for rental work.",
      },
      {
    ...
    de: {
      ...
      summary:
        "Syniotec ist Software für Mietbetrieb: Teams verwalten Equipment, Buchungen und Verträge sowie Abrechnung für Mietgeschäft. Abrechnung läuft nach Haufe X360 für die Finanz, während neue Kunden und Equipment aus X360 direkt nach Syniotec RAM synchronisiert werden, damit die Mietarbeit abgestimmt bleibt.",
      highlights: [
        "Wandelt Mietabrechnung in passende ERP-Belege, damit die Finanzabteilung ein System nutzt.",
        "Überträgt neues Equipment aus Haufe X360 unmittelbar nach Syniotec RAM, damit Planung dieselbe Flotte nutzt.",
        "Überträgt neue Kunden aus Haufe X360 unmittelbar nach Syniotec RAM, damit Buchungen und Rechnungen das richtige Konto treffen.",
      ...
      tasks: [
        ...
        "Neue Kunden aus Haufe X360 sofort nach Syniotec RAM synchronisieren, damit Mietbuchungen und Rechnungen dasselbe Konto nutzen.",
        "Neues Equipment aus Haufe X360 sofort nach Syniotec RAM synchronisieren, damit Planer dieselbe Flotte im Mietsystem sehen.",
      ...
      timeline: [
        ...
        },
        {
          ...
          detail:
            "Kunden und Equipment in Haufe X360 anlegen und sie unmittelbar in Syniotec RAM erscheinen lassen, damit Kennungen und Konten für die Mietarbeit passen.",
        },
        {
